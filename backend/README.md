...
## Project Structure
    ...
    ├── getting_started_mia_40721  # Django project configurations
...
1. Clone this repo and `cd getting_started_mia_40721`
...
2. Clone this repo and `cd getting_started_mia_40721`
